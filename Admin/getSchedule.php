<?php
	...
	$sql = "SELECT S.subjectCode, subjectTitle,
			...
			JOIN curriculum_subject CS ON SO.so_curric ulumSubjectFK = CS.curriculumSubjectCode
			...
			WHERE E.semester = 1 AND E.schoolYear = 2015
			AND SE.sectionCode = 'IT 1-1' GROUP BY S.subjectCode, R.roomType DESC ORDER BY S.subjectTitle;";
